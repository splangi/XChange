...
public class UserTradeTest {
  ...
  public void returnsEqualsCorrectlyWithUnequalUserTradesOfUserTradeAttributes() {
      final UserTrade original = new UserTrade(OrderType.ASK, new BigDecimal("100.501"), CurrencyPair.BTC_USD, new BigDecimal("250.34"), new Date(),
              "id", "FooOrderId", new BigDecimal("0"), Currency.BTC);

      final UserTrade copy = new UserTrade(OrderType.ASK, new BigDecimal("100.501"), CurrencyPair.BTC_USD, new BigDecimal("250.34"), new Date(), "id",
              "BarOrderId", new BigDecimal("0.15"), Currency.USD);
  ...
  public void returnsEqualsCorrectlyWithUnequalUserTradesOfTradeAttributes() {
      final UserTrade original = new UserTrade(OrderType.ASK, new BigDecimal("100.501"), CurrencyPair.BTC_USD, new BigDecimal("250.34"), new Date(),
              "FooTradeId", "OrderId", new BigDecimal("0"), Currency.BTC);

      final UserTrade copy = new UserTrade(OrderType.ASK, new BigDecimal("100.501"), CurrencyPair.BTC_USD, new BigDecimal("250.34"), new Date(),
              "BarTradeId", "OrderId", new BigDecimal("0"), Currency.BTC);
