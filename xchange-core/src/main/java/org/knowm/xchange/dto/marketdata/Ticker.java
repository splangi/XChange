...
public final class Ticker implements Serializable {
    ...
    private final BigDecimal hourOpen;
    private final BigDecimal hourHigh;
    private final BigDecimal hourLow;
    ...
    private Ticker(
        ...
        this.hourHigh = hourHigh;
        this.hourLow = hourLow;
    ...
    public Double changePercent24h(){
        if (last != null && open != null){
            return ((last.doubleValue() - open.doubleValue()) / last.doubleValue()) * 100;
        } else{
            return Double.NaN;
        }
    ...
    public Double changePercent1h(){
        if (last != null && hourOpen != null){
            return ((last.doubleValue() - hourOpen.doubleValue()) / last.doubleValue()) * 100;
        } else{
            return Double.NaN;
        }
    ...
    public static class Builder {
        ...
        private BigDecimal hourOpen;
        private BigDecimal hourHigh;
        private BigDecimal hourLow;
        ...
        public Builder hourLow(BigDecimal hourLow) {
            this.hourLow = hourLow;
            return this;
        }

        public Builder hourHigh(BigDecimal hourHigh) {
            this.hourHigh = hourHigh;
            return this;
        }

        public Builder hourOpen(BigDecimal hourOpen) {
            this.hourOpen = hourOpen;
            return this;
        }
