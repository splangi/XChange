...
public class KucoinCoin {
  ...
  /** @param withdrawFeeRate The withdrawFeeRate */
  @JsonProperty("withdrawFeeRate")
  ...
  /** @param enableWithdraw The enableWithdraw */
  @JsonProperty("enableWithdraw")
  ...
  /** @param enableDeposit The enableDeposit */
  @JsonProperty("enableDeposit")
