...
public class KucoinDealtOrder {
  ...
  public KucoinDealtOrder(
      ...
      String coinType,
      String coinTypePair,
      KucoinOrderType direction,
      KucoinOrderType dealDirection) {
    super();
  ...
  /** @return The coinTypePair */
  @JsonProperty("coinTypePair")
  public String getCoinTypePair() {
    return coinTypePair;
  }

  /** @param coinTypePair The coinTypePair */
  @JsonProperty("coinTypePair")
  ...
  /** @return The dealDirection */
  @JsonProperty("dealDirection")
  public KucoinOrderType getDealDirection() {
    return dealDirection;
  }

  /** @param dealDirection The dealDirection */
  @JsonProperty("dealDirection")
