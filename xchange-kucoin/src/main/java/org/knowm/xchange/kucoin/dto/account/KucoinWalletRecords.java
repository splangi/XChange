...
public class KucoinWalletRecords {
   ...
   */
  public KucoinWalletRecords(
      List<KucoinWalletRecord> records,
      Integer total,
      Integer limit,
      Integer pageNos,
      Integer currPageNo,
      List<Integer> navigatePageNos,
      String coinType,
  ...
  /** @return The navigatePageNos */
  @JsonProperty("navigatePageNos")
  public List<Integer> getNavigatePageNos() {
    return navigatePageNos;
  }

  /** @param navigatePageNos The navigatePageNos */
  @JsonProperty("navigatePageNos")
